...
If you use the Nix package manager, you can build and install Fontist directly:
...
For detailed Nix installation instructions, see link:NIX_INSTALL.md[NIX_INSTALL.md].
